...
<form class="surface elevation-2">
  ...
  <fieldset class="intro">
    ...
    <text-field name="dexid" required list="datalist-pokedex" autocomplete="off" placeholder="Bulbizarre">
      <span slot="label">Espèce</span>
    </text-field>

    <input-select name="forme">
