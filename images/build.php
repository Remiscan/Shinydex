...
function buildIconSheet($logs = false)
{
  ...
  // Init CSS file
  file_put_contents($cssPath, ".icones{background-image:var(--link-iconsheet)}.icones.jeu{display:block;width:32px;height:32px;background-position:32px 32px}.icones.explain{display:inline-block;width:12px;height:12px;margin:3px 0;image-rendering:pixelated}");
